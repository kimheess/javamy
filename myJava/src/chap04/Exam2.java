...
/*
  ...
  [윤년 판단 알고리즘]
  1. 4의 배수인 해는 윤년입니다.
  2. 100의 배수인 해는 평년입니다. ==> 4의배수이고 100의배수가 아니면 윤년입니다.
  3. 400의 배수인 해는 윤년입니다.
...
//		2020: 윤년,  2100: 평년,  2000: 윤년,  2023: 평년 
//		year % 4== 0 && year % 100 !=0 || year % 400==0 4의배수이고 100의배수가 아니면 윤년입니다
...
//		System.out.printf("%d년은 %s 입니다.", year,result);
		...
		if(year % 4== 0 && year % 100 !=0 || year % 400==0 ) { //4의배수이고 100의배수가 아니면 윤년입니다.
			result = "윤년";
		}else {
			result = "평년";
		}
